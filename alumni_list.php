	...
	margin:unset;
        ...
        <header class="masthead">
        	...
        	<div class="container">
		        ...
		        <div class="card-body">
		            <div class="row">
		                ...
		                <div class="col-md-4">
		                    <button class="btn btn-primary btn-block btn-sm" id="search">Cari</button>
		                </div>
		            </div>
            ...
            <div class="container-fluid mt-3 pt-2">
                ...
                $alumni = $conn->query("SELECT a.*,c.course,Concat(a.lastname,', ',a.firstname,' ',a.middlename) as name from bio_alumni a inner join courses c on c.id = a.course_id order by Concat(a.lastname,', ',a.firstname,' ',a.middlename) asc");
                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                ...
                                <p class="filter-txt">Universitas: <b><?php echo $row['course'] ?></b></p>
                                <p class="filter-txt">Tahun Lulus: <b><?php echo $row['batch'] ?></b></p>
                                <p class="filter-txt">Bekerja di: <b><?php echo $row['connected_to'] ?></b></p>
                                    <br>
                                </div>
                            </div>
                        </div>
