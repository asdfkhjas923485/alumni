...
.banner{
   min-height: calc(100%)
        ...
        <header class="masthead">
            <div class="container-fluid h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Selamat datang di Sistem Manajemen Alumni</h3>
            ...
            <div class="container mt-3 pt-2" id="alawi1">
                <h4 class="text-center text-white">Acara Mendatang</h4>
                <hr class="divider">
                <?php
