<!DOCTYPE html>
<html lang="en">
<link rel="icon" type="image/png" href="assets/img/Untitled design.png" />
    <?php
    session_start();
    ...
    <style>
    	header.masthead {
		  background: url(admin/assets/uploads/kELOMPOK2.png);
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=home">Utama</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=careers">Lowongan</a></li>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.c" target="_blank">Kelompok 2</a></div></div>
        </footer>
